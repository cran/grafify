test_that("Check scatter bar plots", {
  sb1 <- plot_scatterbar_sd(data_2w_Tdeath, #plotted with grafify
                        Genotype, 
                        PI,
                        TextXAngle = 45,
                        ColPal = "muted",
...
test_that("Check scatter bar single colour plots", {
  sb1 <- plot_scatterbar_sd_sc(data_2w_Tdeath, #plotted with grafify
                           Genotype, 
                           PI,
                           TextXAngle = 45,
                           colour = "#AB0001") +
