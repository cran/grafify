...
#' - `PrGn_div`
#' 
#' @param palette Name of the `grafify` palettes from above, provide within quotes, e.g., `palette = "vibrant"`. Default discrete palette is `okabe_ito`. For quantitative palette, set `discrete = FALSE` (which will apply `blue_conti` unless another palette is chosen).
...
scale_colour_grafify <- function(palette = "okabe_ito", ColSeq = TRUE, reverse = FALSE, discrete = TRUE, ...){
...
#' @rdname scale_colour_grafify
#' @export scale_color_grafify 
scale_color_grafify <- scale_colour_grafify