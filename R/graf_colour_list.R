...
#' 
#' To visualise these colours use \code{plot_grafify_palette}. `okabe_ito`, `bright`, `contrast`, `dark`, `light`, `muted`, `pale`, `vibrant`, `yello_conti` from Paul Tol's [post](https://personal.sron.nl/~pault/). Zesty, Pastel, Elegant from this [link](https://venngage.com/blog/color-blind-friendly-palette/). Colour hexcodes for `fishy`, `kelly`, `r4`, `safe`, `OrBl_div`, `PrGn_div`, `blue_conti`, `grey_conti` taken from [cols4all:c4a_gui](https://github.com/mtennekes/cols4all) package. All schemes are colourblind-friendly.
#' 
