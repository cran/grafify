...
#' @param xcol name of the column (without quotes) with a X variable (will be forced to be a factor/categorical variable).
...
#' @param ... any additional arguments to pass to \code{\link[ggplot2]{stat_summary}}.
#'
